...
function GogoCharacter(){return <View style={s.characterWrap}><View style={s.hairBack}/><View style={s.hairLeft}/><View style={s.hairRight}/><View style={s.face}><View style={s.browRow}><View style={s.eye}/><View style={s.eye}/></View><View style={s.smile}/></View><View style={s.body}/><View style={s.statusBubble}/></View>}
