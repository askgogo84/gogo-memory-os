...
assert.match(reservation,/action_type:'browser_prepare'/,'reservation life-event action must use a database-allowed action_type')
assert.doesNotMatch(reservation,/action_type:'browser_execute'/,'unsupported action_type must never be inserted')
